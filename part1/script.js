...
function checkUsername(username) {
	var user = document.getElementsByClassName("sign-up__form__block__text_u");
	...
	if (username.trim().length === 0) {
		...
		document.getElementsByClassName("sign-up__form__block__username").style.borderColor = "red";
		...
		document.getElementsByClassName("sign-up__form__block__username").style.borderColor = "green";
	}
	return true;
};

function checkEmail(email) {
	var mail = document.getElementsByClassName("sign-up__form__block__text_e");
	...
	if (!email.trim().match(emailPattern)) {
		...
		document.getElementsByClassName("sign-up__form__block__email").style.borderColor = "red";
		...
		document.getElementsByClassName("sign-up__form__block__email").style.borderColor = "green";
	}
	return true;
};

function checkPassword(password) {
	var pass = document.getElementsByClassName("sign-up__form__block__text_p");
	...
	if (!password.trim().match(passwordPattern)) {
		...
		document.getElementsByClassName("sign-up__form__block__password").style.borderColor = "red";
		...
		document.getElementsByClassName("sign-up__form__block__password").style.borderColor = "green";
	}
	return true;
};

function checkConfirm(password, confirm) {
	var conf = document.getElementsByClassName("sign-up__form__block__text_c");
	...
	if (!confirm.match(password)) {
		...
		document.getElementsByClassName("sign-up__form__block__confirm").style.borderColor = "red";
		...
		document.getElementsByClassName("sign-up__form__block__confirm").style.borderColor = "green";
	}
	return true;
};
...
document.getElementsByClassName("sign-up__form__block__register").addEventListener("click", function(event) {
	...
	var email = document.getElementsByClassName("sign-up__form__block__email").value;
	var password = document.getElementsByClassName("sign-up__form__block__password").value;
	var confirm = document.getElementsByClassName("sign-up__form__block__confirm").value;
...
document.getElementsByClassName("sign-up__form__block__login").addEventListener("click", function(event) {
	event.preventDefault();
